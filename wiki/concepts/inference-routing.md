...
date: 2026-06-12
sources: [llm-d-router-architecture-analysis.md, semantic-router-architecture-analysis.md, gateway-api-inference-extension-architecture-analysis.md, llm-d-inference-sim-architecture-analysis.md, llm-d-batch-gateway-architecture-analysis.md]
related: [[llm-d]], [[semantic-router]], [[ai-gateway]], [[gateway-api]], [[kv-cache-offload]], [[llm-d-inference-sim]], [[llm-d-batch-gateway]], [[batch-inference]]
---
...
不要把所有 router 混为一类。Gateway API router 更靠近 Kubernetes endpoint；semantic router 更靠近 prompt/model selection；KV-aware router 更靠近 serving runtime 和 cache locality。
