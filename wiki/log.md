...
## [2026-07-06] ingest | Kubernetes Resource Orchestration KEPs

- 基于本地 `/Users/zhenyu.jiang/enhancements/keps` 中 `sig-scheduling`、`sig-autoscaling`、`sig-node` 三个 SIG 的 KEP README，新增 [[src-kubernetes-resource-orchestration-keps]]。
- 新开 [[kubernetes-resource-orchestration]] 业务整理域，并拆出 [[kubernetes-scheduling-design]]、[[kubernetes-autoscaling-design]]、[[kubernetes-node-design]] 三条设计主线；同步更新 [[kubernetes]] 与 [[Wiki 索引]]。
